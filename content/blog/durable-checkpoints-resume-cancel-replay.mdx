...
description: "A long agent run that dies at step nine should not restart at step one. How SQLite-backed run state turns a crash into a resume, and why cancel has to be a persisted flag."
date: "2026-06-22"
updated: "2026-07-26"
