...
description: "Split the API from the landing site, keep write keys server-only, force simulate on the public demo, and let the container set server mode so Bash fails closed. A production deploy walkthrough."
date: "2026-05-12"
updated: "2026-07-26"
