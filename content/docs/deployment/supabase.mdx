...
Optional persistence uses the same schema as [`SwarmStore`](https://github.com/TechTideOhio/swarm-357).

## Apply migration

1. Open your Supabase project → **SQL Editor**.
2. Run [`database/migrations/001_initial.sql`](https://github.com/TechTideOhio/swarm-357) in order (single file is self-contained).
