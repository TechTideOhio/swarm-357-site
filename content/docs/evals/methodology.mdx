...
Swarm 357 ships a budgeted evaluation suite under [`evals/`](https://github.com/TechTideOhio/swarm-357). Numbers in this document are generated from [`evals/baselines/latest.json`](https://github.com/TechTideOhio/swarm-357) via [`scripts/render_eval_assets.py`](https://github.com/TechTideOhio/swarm-357) - do not hand-edit metrics.
...
25 tasks in [`evals/tasks.yaml`](https://github.com/TechTideOhio/swarm-357): **20 single-agent**, **5 swarm**. Layers: research, sales, support, marketing, SEO, operations, management.
...
![Eval results by layer](https://github.com/TechTideOhio/swarm-357)
...
See also [`evals/README.md`](https://github.com/TechTideOhio/swarm-357).

## Related reading

- [How to actually evaluate an agent swarm](/blog/how-to-evaluate-an-agent-swarm)
