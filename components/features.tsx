...
function FeatureCard({
  ...
  return (
    <motion.div
      className="bg-muted grid grid-cols-1 gap-2 overflow-hidden rounded-2xl border border-neutral-200/10 p-2 shadow-2xl/20 transition-colors duration-300 hover:bg-muted/80 md:grid-cols-2"
    ...
    <section className="bg-background px-6 py-16 md:py-32">
      <div className="mx-auto flex max-w-6xl flex-col gap-12 lg:flex-row lg:items-start lg:gap-16">
        ...
        >
          ...
          <a
            href="#"
            className="bg-foreground group inline-flex w-full items-center justify-center gap-3 rounded-md py-3 pr-3 pl-4 font-medium tracking-tight text-background shadow-lg shadow-black/10 transition-all duration-500 ease-out hover:rounded-[50px] hover:shadow-xl hover:shadow-black/20 sm:w-auto"
          >
